                ...
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                    {rating.rater.profilePicture ? (
                      <img
                        src={rating.rater.profilePicture.startsWith('http') ? rating.rater.profilePicture : `${(import.meta.env.VITE_API_URL || 'http://localhost:5000/api').replace(/\/api$/i,'')}${rating.rater.profilePicture}`}
